...
const GET_CITIES_API =
  'http://api.openweathermap.org/data/2.5/find?lat=23.68&lon=90.35&cnt=50&appid=8dc478c552009be10caa2621da8b8fd5';
const GET_TEMPERATURE_API = params =>
  `http://api.openweathermap.org/data/2.5/weather?lat=${params.lat}&lon=${params.lon}&appid=8dc478c552009be10caa2621da8b8fd5&units=metric`;
